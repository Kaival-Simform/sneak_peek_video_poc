...
//    @IBOutlet private var recordButton: UIButton!
    let frontCameraVideoPreviewView = PreviewView(frame: CGRect(x: 0, y: 0, width: 100, height: 300))
    let backCameraVideoPreviewView = PreviewView(frame: CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width, height: UIScreen.main.bounds.height))
